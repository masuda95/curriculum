    ...
    <body>
        ...
        <form id="loginForm" name="loginForm" action="" method="POST">
            <fieldset>
                ...
                <div><form color="#ff0000"><?php echo htmlspecialchars($errorMessage, ENT_QUOTES); ?></form></div>
                <div><form color="#0000ff"><?php echo htmlspecialchars($signUpMessage, ENT_QUOTES); ?></form></div>
